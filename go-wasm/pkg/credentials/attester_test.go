...
var (
	...
	reqForAttestationTooMay = []byte(`{"commitMsg":{"U":"gCSi91WURh6LaTPZKcYXfVzcrUM1mrVgP2HhxdHBQnVka9/7IPHmLG9IqHTNLIWQjwbfNSNRc0Qrv4gQEsbfHMROWFXFaXO6oXNlUyJsZJ1yHE7ChXccxpI8LOlGWyPBPAsU/MG2NTDZR4FhscE71p9su1MCK5vC8dF2Lp3gWJ0=","n_2":"nTqsoSLjxwzGfg==","combinedProofs":[{"U":"gCSi91WURh6LaTPZKcYXfVzcrUM1mrVgP2HhxdHBQnVka9/7IPHmLG9IqHTNLIWQjwbfNSNRc0Qrv4gQEsbfHMROWFXFaXO6oXNlUyJsZJ1yHE7ChXccxpI8LOlGWyPBPAsU/MG2NTDZR4FhscE71p9su1MCK5vC8dF2Lp3gWJ0=","c":"pK7xOxIl2G07p8OFZff9I5xRD2lepTQ1HGQ3JAJ9YMw=","v_prime_response":"YuofD2+UGe79SPCydtgPa7S6YuIBOoqlVRrf5E9Z/ZESM0AvRPhLxKGclC9bEzbxTAOkq+tG4zK6WDK9zJwquGO5y8aERcuDjdM8gYNqRXbyjnoYU1sE2wuHUUKTkW5VGTisu2S4og5dUgVvpcYy1yQmFFeeUNUsrmVC0uvJFE+jKUI00DPlVg8r9P7OxKCMnIPIK5OTnZIa96ZqvxPdRPatXthyPPG+rDh2uzrbAHagH9ma","s_response":"i3QfqU9LTsO2IJDcDmq+attKiWvMK8Gr78Um3WKswDe8IPWD3avIFhxAd7WuUAO9HnxgH6jbDFKk24zqMR6R2ssJTnOVnzal05U="}]},"claim":{"contents":{"age":34,"gender":"female","name":[{"a":1,"b":2},2,3],"special":true,"special1":true,"special2":true,"special3":true,"special4":true,"special5":true,"special6":true,"special7":true},"ctype":"0xDEADBEEFCOFEE"}}`)
)
...
func TestSignTooMany(t *testing.T) {
	...
	attest, w, err := attester.AttestClaim(request, session, update)
	assert.Error(t, err)
	assert.Nil(t, attest)
	assert.Nil(t, w)
}
