...
function votingBalancesNominatorsFor(api) {
  return address => api.derive.accounts.info(address).pipe((0, _operators.switchMap)((_ref) => {
    let {
      accountId
    } = _ref;
    return accountId ? api.query.staking.nominatorsFor(accountId) : (0, _rxjs.of)([]);
  }), (0, _operators.switchMap)(accounts => api.derive.balances.votingBalances(accounts)), (0, _util.drr)());
}