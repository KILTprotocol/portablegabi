...
describe('DID', () => {
    require('../blockchain/Blockchain').default.__mockQueryDidDids = jest.fn(address => {
        if (address === 'withDocumentStore') {
            ...
            [types_1.Text, types_1.Text, types_1.U8a], ['0x987', '0x123', '0x687474703a2f2f6d794449442e6b696c742e696f']);
    ...
    it('get default did document', async () => {
        ...
        expect(did.getDefaultDocument('http://myDID.kilt.io/service')).toEqual({
            ...
            publicKey: [
                {
                    controller: 'did:kilt:5FA9nQDVg267DEd8m1ZypXLBnvN7SFxYwV7ndqSYGiN9TTpu',
    ...
    it('gets identifier from address', () => {
        expect(__1.Did.getIdentifierFromAddress('5F59aUtyDc54Sx2yA1hHgncBErSPWRAt5SgQXvPjVNEMPCqY')).toBe('did:kilt:5F59aUtyDc54Sx2yA1hHgncBErSPWRAt5SgQXvPjVNEMPCqY');
    });
    it('gets address from identifier', () => {
        expect(__1.Did.getAddressFromIdentifier('did:kilt:5F59aUtyDc54Sx2yA1hHgncBErSPWRAt5SgQXvPjVNEMPCqY')).toBe('5F59aUtyDc54Sx2yA1hHgncBErSPWRAt5SgQXvPjVNEMPCqY');
    });
});
