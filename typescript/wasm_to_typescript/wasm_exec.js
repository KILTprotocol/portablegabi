...
module.exports.exec = (myFn, myFnArgs) => {
  // wasm file needs to be in root dir due to fs
  ...
  if (
    ...
    // function return
    return WebAssembly.instantiate(fs.readFileSync(wasmFile), go.importObject)
      .then(result => {
        ...
        // add function with args to promiser and return
        return promiser(
          global[myFn],
