const testEnv = {
  ...
  claimRaw: { name: 'Jasper', age: 42, gender: 'male', origin: 'Germany' },
  ctype: JSON.stringify({
    schema: {
      $id: 'DriversLicense',
    ...
    owner: '5EcrHNLzM321yWBf8QsSEJX1h4cFyzQ9TjZ1HEks4uAnnHP9',
    hash: '0xde9f624875aa620d06434603787a40c8cd02cc25c7b775cf50de8a3a96bbeafa',
  }),
  disclosedAttributes: [
    'ctype',
    'contents.name',
